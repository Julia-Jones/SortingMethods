...
int total =0;
    ...
    private void sortActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sortActionPerformed
     ...
     //Iterator is used to go through a collection, in this case, an ArrayList
       ...
       //converting the arraylist to an array so it is compatable with the following sorting methodes. 
       Integer[] wrapperArr = integer.toArray(new Integer[integer.size()]);
       
       int temp2; 
       if(select.isSelected() && ascending.isSelected()){
           
             for(int l=0; l< integer.size() - 1; l++){
                         wrapperArr[0] = wrapperArr[l];
                   for (int j = l+1; j<integer.size(); j++){
                        if (wrapperArr[l] > wrapperArr[j]){
                         wrapperArr[0] = j;
                    // Swap the entries
                         temp2 = wrapperArr[l];
       ...
       }else if(select.isSelected() && descending.isSelected()){
        
    }else if(bubble.isSelected() && ascending.isSelected()){
